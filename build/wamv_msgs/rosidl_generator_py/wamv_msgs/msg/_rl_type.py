...
class Metaclass_RLType(type):
    """Metaclass of message 'RLType'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'wamv_msgs.msg.RLType')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rl_type
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rl_type
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rl_type
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rl_type
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rl_type
...
class RLType(metaclass=Metaclass_RLType):
    """Message class 'RLType'."""
    ...
    def left_thrust(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'left_thrust' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def right_thrust(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'right_thrust' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
