...
bool wamv_msgs__msg__navigation_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wamv_msgs.msg._navigation_type.NavigationType", full_classname_dest, 45) == 0);
  }
  wamv_msgs__msg__NavigationType * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of NavigationType */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wamv_msgs.msg._navigation_type");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NavigationType");
