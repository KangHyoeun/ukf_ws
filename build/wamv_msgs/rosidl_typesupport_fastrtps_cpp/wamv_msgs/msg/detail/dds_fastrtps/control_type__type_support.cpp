...
#include "wamv_msgs/msg/detail/control_type__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wamv_msgs::msg::ControlType & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wamv_msgs::msg::ControlType & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wamv_msgs::msg::ControlType;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wamv_msgs::msg::ControlType *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wamv_msgs::msg::ControlType *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ControlType__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wamv_msgs::msg::ControlType *>(
...
static size_t _ControlType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ControlType(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ControlType__callbacks = {
  "wamv_msgs::msg",
  "ControlType",
...
static rosidl_message_type_support_t _ControlType__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ControlType__callbacks,
...
{
  return &wamv_msgs::msg::typesupport_fastrtps_cpp::_ControlType__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wamv_msgs, msg, ControlType)() {
  return &wamv_msgs::msg::typesupport_fastrtps_cpp::_ControlType__handle;
}
