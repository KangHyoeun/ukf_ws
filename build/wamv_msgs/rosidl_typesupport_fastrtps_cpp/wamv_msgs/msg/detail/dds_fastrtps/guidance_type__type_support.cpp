...
#include "wamv_msgs/msg/detail/guidance_type__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wamv_msgs::msg::GuidanceType & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wamv_msgs::msg::GuidanceType & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wamv_msgs::msg::GuidanceType;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wamv_msgs::msg::GuidanceType *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wamv_msgs::msg::GuidanceType *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GuidanceType__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wamv_msgs::msg::GuidanceType *>(
...
static size_t _GuidanceType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GuidanceType(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GuidanceType__callbacks = {
  "wamv_msgs::msg",
  "GuidanceType",
...
static rosidl_message_type_support_t _GuidanceType__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GuidanceType__callbacks,
...
{
  return &wamv_msgs::msg::typesupport_fastrtps_cpp::_GuidanceType__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wamv_msgs, msg, GuidanceType)() {
  return &wamv_msgs::msg::typesupport_fastrtps_cpp::_GuidanceType__handle;
}
