...
static const _RLType_type_support_symbol_names_t _RLType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wamv_msgs, msg, RLType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wamv_msgs, msg, RLType)),
  }
};
...
{
  return &::wamv_msgs::msg::rosidl_typesupport_cpp::RLType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wamv_msgs, msg, RLType)() {
  return get_message_type_support_handle<wamv_msgs::msg::RLType>();
}
